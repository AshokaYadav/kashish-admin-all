...
interface FilterValues {
    circle: string;
    identifier: string;
    identifierType: 'operatorId' | 'orderId';
...
interface RechargeFiltersProps {
    ...
    updateQuery: (k: string, v: string) => void;
...
const RechargeFilters: React.FC<RechargeFiltersProps> = ({ reset, handleSearchFilter, query, updateQuery }) => {
    const [filtersVisible, setFiltersVisible] = useState(false);

    const [filters, setFilters] = useState<FilterValues>({
        circle: '',
        identifier: '',
        identifierType: 'operatorId',
        userIdentifier: '',
                    ...
                    <CardContent className="pt-6">
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div>
                                    ...
                                    <Select
                                        ...
                                        onValueChange={(value) => updateQuery('circle', value)}
                                    >
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex space-x-2">
                                        <Select
                                            ...
                                            onValueChange={(value: 'operatorId' | 'orderId') => handleChange('identifierType', value)}
                                        >
                                            <SelectTrigger className="w-32">
                                                <SelectValue placeholder="Type" />
                                            </SelectTrigger>
                                            <SelectContent>
                                                <SelectItem value="operatorId">Operator</SelectItem>
                                                <SelectItem value="orderId">Order ID</SelectItem>
                                            </SelectContent>
                                        </Select>
                                        <Input
                                            placeholder="Enter value"
                                            value={query[filters.identifierType]}
                                            onChange={(e) => updateQuery(filters.identifierType, e.target.value)}
                                            className="flex-1"
                                        />
                                    </div>
                                </div>
                                ...
                                <div className="flex flex-col">
                                    ...
                                    <div className="flex space-x-2">
                                        <Select
                                            ...
                                            onValueChange={(value: 'email' | 'mobile') => handleChange('userIdentifierType', value)}
                                        >
                                            <SelectTrigger className="w-32">
                                                <SelectValue placeholder="Type" />
                                            </SelectTrigger>
                                        ...
                                        <Input
                                            placeholder="Enter value"
                                            value={query[filters.userIdentifierType]}
                                            onChange={(e) => updateQuery(filters.userIdentifierType, e.target.value)}
                                            className="flex-1"
                                        />
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <Input
                                        ...
                                        value={query.amount}
                                        onChange={(e) => updateQuery('amount', e.target.value)}
                                    />
                                </div>
                            ...
                            <div className="flex justify-end space-x-2 mt-6">
                                ...
                                <Button variant='default' onClick={handleSearchFilter}>
