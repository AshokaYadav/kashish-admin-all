...
//     1
//     return (
//         <div className="rounded-lg border border-gray-400 bg-white shadow-sm">
//             <Table>
//                 <TableHeader>
...
export function TransactionTable({ transactions, isLoading }: TransactionTableProps) {
  ...
  const renderTransactionIcon = (type: string,msg:string) => {
    const { icon } = getTransactionType(type,msg);
    return icon === 'up' ?
    <ArrowDownCircle className="h-4 w-6 text-blue-500 " />:
      <ArrowUpCircle className="h-4 w-5 text-emerald-500" /> ;
  };
  ...
  //             <TableHeader>
  //                 <TableRow className="bg-gray-50/50">
  //                     <TableHead className="text-gray-600 text-gray-600 border-r border-gray-200 p-3">Sr.No</TableHead>

  //                     <TableHead className="text-gray-600 text-gray-600 border-r border-gray-200 p-3">Time</TableHead>
  //                     <TableHead className="text-gray-600 text-gray-600 border-r border-gray-200 p-3">Type</TableHead>
  //                     <TableHead className="text-gray-600 text-center text-gray-600 border-r border-gray-200 p-3">Remark</TableHead>

  //                     <TableHead className="text-gray-600 text-center text-gray-600 border-r border-gray-200 p-3">Transaction Amount</TableHead>
  //                     <TableHead className="text-gray-600 text-center text-gray-600 border-r border-gray-200 p-3">Opening Balance</TableHead>


  //                     <TableHead className="text-gray-600 text-gray-600 border-r border-gray-200 p-3">Credit</TableHead>
  //                     <TableHead className="text-gray-600 text-gray-600 border-r border-gray-200 p-3">Debit</TableHead>

  //                     {/* <TableHead className="text-gray-600">Status</TableHead> */}
  //                     {/* <TableHead className="text-gray-600 text-center">Recharge Detail</TableHead> */}
  //                     <TableHead className="text-gray-600 text-center text-gray-600 border-r border-gray-200 p-3">Closing Balance</TableHead>
  //                     {/* <TableHead className="text-gray-600 text-center">Order Id</TableHead> */}
  //                     {/* <TableHead className="text-gray-600 text-center">Payment Id</TableHead> */}
  //                     {/* <TableHead className="text-gray-600 text-center">RRN</TableHead>
  //                     <TableHead className="text-gray-600 text-center">UPI</TableHead> */}
  ...
  //                         <TableCell className="text-gray-600 border-r border-gray-200 p-3">
  //                             {index + 1}
  //                         </TableCell>
  //                         <TableCell className="text-gray-600 border-r border-gray-200 p-3">
  ...
  //                         <TableCell className="border-r border-gray-200 p-3">
  ...
  //                             </div>
  //                         </TableCell>
  //                         {/* <TableCell className="text-center font-medium text-gray-700 border-r border-gray-200 p-3">
      ...
      <Table>
        <TableHeader>
          <TableRow className="bg-gray-400">
            <TableHead className="text-center text-black border border-gray-300 p-3">Sr.No</TableHead>

            <TableHead className="text-center text-black border border-gray-300 p-3">Time</TableHead>
            <TableHead className="text-center text-black border border-gray-300 p-3">Type</TableHead>
            <TableHead className=" text-center text-black border border-gray-300 p-3">Remark</TableHead>
            <TableHead className="text-center text-black border border-gray-300 p-3">Order Id</TableHead>
            <TableHead className="text-center text-black border border-gray-300 p-3">Transaction Amount</TableHead>
            <TableHead className="text-center text-black border border-gray-300 p-3">Opening Balance</TableHead>


            <TableHead className="text-black text-black border border-gray-300 p-3">Credit</TableHead>
            <TableHead className="text-black text-black border border-gray-300 p-3">Debit</TableHead>

            {/* <TableHead className="text-black">Status</TableHead> */}
            {/* <TableHead className="text-black text-center">Recharge Detail</TableHead> */}
            <TableHead className="text-black text-center text-black border border-gray-300 p-3">Closing Balance</TableHead>
            {/* <TableHead className="text-gray-600 text-center">Order Id</TableHead> */}
            {/* <TableHead className="text-gray-600 text-center">Payment Id</TableHead> */}
            {/* <TableHead className="text-gray-600 text-center">RRN</TableHead>
                        <TableHead className="text-gray-600 text-center">UPI</TableHead> */}
        ...
        <TableBody>
          {transactions.map((transaction, index) => (
            <TableRow key={transaction.id} className="hover:bg-gray-50/50 border even:bg-gray-200">
              ...
              <TableCell className="border border-gray-400 p-3">
                <div className="flex items-center gap-1 text-gray-600">
                  {/* {transaction.type} */}
                  {renderTransactionIcon(transaction.type,transaction.msg)}
                  <span className={`${getTransactionType(transaction.type,transaction.msg).color} text-gray-600`}>
                    {transaction.type?.includes("RECHARGE_DEBIT")
                      ? "Recharge Debit"
                      : transaction.type?.includes("RECHARGE_COMMISSION") && (transaction.msg=="REFUNDED" || transaction.msg=="Transaction Failed by Admin")  ? "Recharge Refund":
                      transaction.type?.includes("RECHARGE_COMMISSION") && (transaction.msg!=="REFUNDED") 
                        ? "Recharge Commission"
                        : "Add New Balance"//formatTransactionType(transaction.type)
                    }
                  </span>
                    ...
                    {transaction.msg === "Successfully Accepted" &&
                      ...
                      (
                        <div className="flex items-center space-x-3">
                          <div className="flex flex-col space-y-1">
                            <span>
                              COMMISSION OF {transaction.rechargeData?.operator?.name}
                              {transaction.rechargeData?.circle?.name
                                ? ` [${transaction.rechargeData.category.name}] `
                                : ""}
                              No. {transaction.rechargeData?.mobile}
                          ...
                          <div className="flex flex-col space-y-1">
                            <span>
                              {transaction.msg === "Transaction Failed by Admin"
                                ? "Failed By Admin"
                                : transaction.msg=="Success" ?"SUCCESS BY API":
                                transaction.msg==="REFUNDED"?"FAILED BY API":
                                "Refund To"}{" "}
                              {transaction.rechargeData?.operator?.name}
                              {transaction.rechargeData?.circle?.name
                                ? ` [${transaction.rechargeData.category.name}] `
  ...
  {transaction?.rechargeData?.id
    ...
    "---"}
              ...
              {/* 
<TableCell className="text-center text-[11px] font-bold text-gray-700 border border-gray-200 p-3 whitespace-nowrap">
  {transaction?.id
