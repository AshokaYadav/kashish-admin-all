...
import { fetchRechargeLogs } from '@/apis/recharge/history';
...
export default function ApiLogs() {
    ...
    const fetchLogs = async (page: number, limit: number) => {
        try {
            setLoading(true);
            const response = await fetchRechargeLogs({ page, limit });
    ...
    return (
        <div className="container mx-auto px-4 py-8">
            <Head>
                <title>Recharge API Response Logs</title>
                <meta name="description" content="View API response logs" />
            </Head>

            <h1 className="text-3xl font-bold mb-6">Recharge API Response Logs</h1>
