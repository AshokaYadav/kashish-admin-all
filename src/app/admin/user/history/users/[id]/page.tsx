...
import { useTransactions } from '../[id]/hooks/useTransactions';
import { TransactionFiltersSection } from '../[id]/components/TransactionsFilterSection';
import { TransactionTable } from '../[id]/components/TransactionsTable';
import { TransactionPagination } from '../[id]/components/TransactionsPagination';
import DateRangeSelector from '../[id]/components/DateRange';
            ...
            const RechargeHistoryPDF = ({ data }: { data: ITxnHistory[] }) => (
                <Document>
                    <Page size="A4" style={styles.page}>
                        <Text style={styles.title}>Recharge History Report</Text>

                        <Text style={styles.subtitle}>Recharge Details</Text>
                        ...
                        <View style={styles.summary}>
                            ...
                            <View style={styles.row}>
                                ...
                                <Text style={styles.value}>{data.filter((item: any) => (item.status === 'SUCCESS' && item.type === 'RECHARGE_DEBIT') ).reduce((sum: number, item: any) => sum + (item.amount || 0), 0).toFixed(2)}</Text>
                            </View>
