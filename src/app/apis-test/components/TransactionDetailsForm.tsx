...
const formSchema = z.object({
  ...
  operatorCodeColumn: z.string().min(1, 'Operator code column is required'),
  numberColumn: z.string().min(1, 'Number column is required'),
  orderIdColumn: z.string().min(1, 'Order ID column is required'),
  amountColumn: z.string().min(1, 'Amount column is required'),
  field1Column: z.string().optional(),
  field2Column: z.string().optional(),
  ...
  requestedOrderId: z.string().min(1, 'Requested order ID is required'),
  apiOrderId: z.string().min(1, 'API order ID is required'),
  messageKey: z.string().min(1, 'Message key is required'),
  errorCodeColumn: z.string().min(1, 'Error code column is required'),
...
export function TransactionDetailsForm({
  ...
  defaultValues = {
    ...
    statusCode: 'TRNSTATUS',
    successCode: '1',
    failedCode: '2,3',
    refundCode: '5',
    operatorReference: 'OPRID',
    requestedOrderId: 'REFNO',
    apiOrderId: 'TRNID',
    messageKey: 'STATUSMSG',
    errorCodeColumn: 'STATUSCODE',
    errorCode: '0',
    requestType: 'GET',
    responseType: 'JSON',
  },
  ...
  return (
    <Card className="w-full max-w-6xl mx-auto bg-slate-50 my-4">
      <CardHeader>
        <CardTitle className="text-xl text-slate-700">Update Transaction Details</CardTitle>
      </CardHeader>
      <CardContent>
        <Form {...form}>
          <form onSubmit={form.handleSubmit(handleSubmit)} className="space-y-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              ...
              <FormField
                control={form.control}
                name="operatorCodeColumn"
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-1">
                      Operator Code Column<span className="text-red-500">*</span>
                    </FormLabel>
                    <FormControl>
                      <Input placeholder="Operator code field name" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-1">
                      Number Column<span className="text-red-500">*</span>
                    </FormLabel>
                    <FormControl>
                      <Input placeholder="Number field name" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-1">
                      Order Id Column<span className="text-red-500">*</span>
                    </FormLabel>
                    <FormControl>
                      <Input placeholder="Order ID field name" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Amount field name" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Field 1 Column</FormLabel>
                    <FormControl>
                      <Input placeholder="Field 1 name (optional)" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Field 2 Column</FormLabel>
                    <FormControl>
                      <Input placeholder="Field 2 name (optional)" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Extra field name (optional)" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
              ...
              <FormField
                control={form.control}
                name="requestedOrderId"
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-1">
                      Requested Order Id<span className="text-red-500">*</span>
                    </FormLabel>
                    <FormControl>
              ...
              <FormField
                control={form.control}
                name="errorCodeColumn"
                render={({ field }) => (
                  <FormItem>
                    <FormLabel className="flex items-center gap-1">
                      Error Code Column<span className="text-red-500">*</span>
                    </FormLabel>
                    <FormControl>
                      <Input placeholder="Error code field name" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="Error code value" {...field} />
                    </FormControl>
                  </FormItem>
                )}
              />
