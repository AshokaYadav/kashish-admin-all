...
const formSchema = z.object({
    ...
    errorMessageColumn: z.string().min(1, 'Error message column is required'),
...
interface StatusCheckDetailsFormProps {
    onSubmit: (values: FormValues) => void;
    defaultValues?: Partial<FormValues>;
}

export function StatusCheckDetailsForm({
    onSubmit,
    defaultValues = {
        ...
        failedCode: '2,3',
        refundCode: '5',
        messageKey: 'TRNSTATUSDESC',
        extraColumn: '',
        requestType: 'GET',
        responseType: 'JSON',
    },
}: StatusCheckDetailsFormProps) {
    ...
    return (
        <Card className="w-full max-w-6xl mx-auto bg-slate-50 my-4">
            <CardHeader>
                <CardTitle className="text-xl text-slate-700">Update Status Check Details</CardTitle>
            </CardHeader>
            <CardContent>
                <Form {...form}>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="flex items-center gap-1">
                                            Response Format Column<span className="text-red-500">*</span>
                                        </FormLabel>
                                        <FormControl>
                            ...
                            <FormField
                                control={form.control}
                                name="errorMessageColumn"
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="flex items-center gap-1">
                                            Error Message Column<span className="text-red-500">*</span>
                                        </FormLabel>
                                        <FormControl>
                                            <Input placeholder="Error message field name" {...field} />
                                        </FormControl>
                                    </FormItem>
                                )}
                            />
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="flex items-center gap-1">
                                            Requested_Order Id<span className="text-red-500">*</span>
                                        </FormLabel>
                                        <FormControl>
